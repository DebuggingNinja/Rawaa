...
<div class="container-fluid">
              ...
              <table class="table mb-0 table-borderless">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="userDatatable-content">
                        @if(($paymentReminder->supplier?->balance??0) > 0)
                          <span class="text-danger fw-bold">
                          {{
                          __(
                          'supplier.We owe the supplier :amount RMB'
                          ,['amount'=>number_format(($paymentReminder->supplier?->balance ?? 0)
                          *-1, 2, '.', ',')]) }}
                        </span>
                        @elseif(($paymentReminder->supplier?->balance??0) == 0)
                        ...
                        @else
                          ...
                          ,['amount'=>number_format(abs($paymentReminder->supplier?->balance ?? 0),
                          2, '.', ',')]) }}
                        </span>
                        @endif
                      </div>
                    ...
                    <td>
                      <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                        <a href="#" class="btn btn-success w-auto mx-2 pay" data-bs-toggle="modal"
                          ...
                          data-payment-amount="{{ abs($paymentReminder->supplier?->balance??0) }}">{{
  ...
  <div class="row">
    <div class="col-lg-12 mb-30">
      <div class="card">
        <div class="card-header color-dark fw-500">
          {{trans('supplier.Unscheduled Payments')}}
        </div>
        <div class="card-body">
          <div class="userDatatable global-shadow border-light-0 w-100">
            <div class="table-responsive">
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                        ...
                        <a href="#" class="btn btn-success w-auto mx-2 pay" data-bs-toggle="modal"
                          data-bs-target="#PaymentModal" data-supplier-id="{{ $supplier->id }}"
                          data-payment-amount="{{ abs($supplier->balance??0) }}">{{
                          __('supplier.pay_now') }}</a>

                        <a href="#" class="btn btn-dark w-auto mx-2 schedule-date" data-bs-toggle="modal"
                          data-bs-target="#schedulePaymentDateModal" data-supplier-id="{{ $supplier->id }}">{{
